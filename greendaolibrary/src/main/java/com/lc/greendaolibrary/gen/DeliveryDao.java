...
public class DeliveryDao extends AbstractDao<Delivery, Long> {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_DELIVERY_SORT ON \"DELIVERY\"" +
                " (\"SORT\" ASC);");
    }
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Delivery entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Delivery entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(Delivery entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Delivery entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Delivery entity) {
